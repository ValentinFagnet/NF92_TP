...
<html lang="fr" dir="ltr">
  ...
  <body>
    ...
    <p class="texte">
      Ce formulaire vous permet de désinscrire un élève d'une séance de code qui n'a pas encore eu lieu.<br>
      Tout d'abord, vous devez sélectionner une séance qui n'a pas encore eu lieu.
    </p>
    ...
    <?php
      ...
      if (!$result) {
        ...
        echo "</select>";
        echo "<br>";
        echo "<input type='submit' value='Désinscrire un élève pour cette séance'>";
        echo "</form></div>";
      }
