...
<html lang="fr" dir="ltr">
  ...
  <body>
    ...
    <p class='texte'>
      Ce formulaire vous permet de consulter la fiche identité d'un élève ainsi que ses résultats aux séances de code.<br>
      Pour consulter un élève, il suffit de sélectionner un élève dans le menu déroulant ci-dessous.<br><br>
    </p>
    ...
    <?php
      ...
      if (!$result){ // Si la requête n'est pas valide
        ...
        echo "<br>Aucun élève n'a pu être sélectionné.";
      }else { // Si la requête est valide

        // Formulaire pour sélectionner l'élève à consulter
        echo "<div class='formula'><form method='POST' action='consulter_eleve.php'>";

        // Menu déroulant
        echo "Consulter l'élève :<br>";
        ...
        echo "</select>";
        echo "<br>";
        echo "<input type='submit' value='Consulter élève'>";
        echo "</form></div>";
      }
